...
class Permissions
{
    ...
    public static function catalog(): array
    {
        return [
            ...
            ['key' => 'scheduler.view', 'label' => 'View Scheduler Logs', 'group' => 'Settings'],
    ...
    public static function defaultPages(): array
    {
        return [
            ...
            ['path' => '/marketplace/tiktok-shop?tab=orders', 'label' => 'Orders'],
            ...
            ['path' => '/scheduler-logs', 'label' => 'Scheduler Logs'],
